...
PROMPT_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "..", "prompts", "domain_hardware.txt")


def hardware_agent(state: ProjectState) -> dict:
    with open(PROMPT_PATH, "r") as f:
        system_prompt = f.read()

    target_files = ["hardware.md", "software.md"]
    wiki_context = ""
